...
Esta alteração foi conciliada com a main e as correções de importação na versão consolidada; ver pwa-openfinance.md. Preservar a implementação React recebida do Google; não trazer a antiga interface JavaScript da primeira proposta por cima desta versão.
